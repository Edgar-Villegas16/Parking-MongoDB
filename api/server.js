...
app.use('/api', require('../api/routes/route_solicitud_parqueo/solicitud_parqueo.route'));
app.use('/api', require('../api/routes/registrar_tarifa.route'));


app.use('/api', require('../api/routes/registrar-convenio-route'));
app.use('/api', require('../api/routes/registrar-parametro-route'));
app.use('/api', require('../api/routes/registrar-empleado-route'));


app.use('/api', require('../api/routes/registrar-admin-general-route'));
app.use('/api', require('../api/routes/registrar-reserva-route'));


app.use('/api', require('../api/routes/registrar_cliente.route'));

app.use('/api', require('../api/routes/registrar_empresa.route'));